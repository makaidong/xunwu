package com.gyw.web.controller.house;
...
import com.gyw.base.RentValueBlock;
...
import com.gyw.service.search.HouseBucketDTO;
...
public class HouseController {
    ...
    public String show(@PathVariable(value = "id") Long houseId,
        ...
        if(userDTOServiceResult.getResult().getAvatar() == null || userDTOServiceResult.getResult().getAvatar().equals("")){
            userDTOServiceResult.getResult().setAvatar("/static/images/user/default-avatar.png");
        }
